...
public class JdbcDirectoryManager implements IDirectoryManager {
	...
	//All DAO methods for Group bean
	...
	//All DAO methods for Person bean
	...
	@Override
	public Collection<Person> findLimitPersons(Integer offset, 
			Integer maxRows) {
	...
	@Override
	public Collection<Person> findLimitGroupPersonsById(Long groupId, 
	...
	//All DAO methods for table User_roles
	//method to update username(mail) on table User_roles 
	//when person details is updated 
	...
	public String findUsernameUserRolesByUsername(String personMail){
		String sql = "SELECT username FROM User_roles "
				+ "WHERE username = ?;";
		String returnMail = "";
		Object[] args = { personMail};
		int [] argTypes = {Types.VARCHAR};
		returnMail = jdbcTemplate.queryForObject(sql, args, argTypes, 
				String.class);
		return returnMail;
	}
